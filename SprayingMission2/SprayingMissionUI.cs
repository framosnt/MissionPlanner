...
{
    public partial class SprayingMissionUI : Form
    {
        ...
        public SprayingMissionUI(SprayingMissionPlugin plugin)
        {
            this.plugin = plugin;
            InitializeComponent();
            loading = true;
        ...
        private void SprayingMissionUI_Load(object sender, EventArgs e)
        {
            loading = true;
            if (!loadedfromfile)
                 loadsettings();
        ...
        public void LoadSprayingMission()
        {
            System.Xml.Serialization.XmlSerializer reader = new System.Xml.Serialization.XmlSerializer(typeof(SprayingMissionData));
            ...
            using (OpenFileDialog ofd = new OpenFileDialog())
            {
                ...
                if (File.Exists(ofd.FileName))
                {
                    ...
                    {
                        var test = (SprayingMissionData)reader.Deserialize(sr);

                        loading = true;
                        
                        loadsprayingmissiondata(test); 
        ...
        void loadsprayingmissiondata(SprayingMissionData griddata)
        {
            list = griddata.poly;
        ...
        SprayingMissionData savesprayingmissiondata()
        {
            SprayingMissionData griddata = new SprayingMissionData();
        ...
        public void SaveSprayingMission()
        {
        ...
        private void BUT_Accept_Click_1(object sender, EventArgs e)
        {
        ...
        private void SprayingMissionUI_Load_1(object sender, EventArgs e)
        {
            domainUpDown1_ValueChanged(this, null);
            TRK_zoom.Value = (float)map.Zoom;
        }
