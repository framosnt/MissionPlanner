...
{ //global::Android.Content.Intent.CategoryLauncher
  //global::Android.Content.Intent.CategoryHome,
    ...
    [Activity(Label = "BonsVoos MP", ScreenOrientation = ScreenOrientation.SensorLandscape, Icon = "@mipmap/icon", Theme = "@style/MainTheme", 
        ...
        public override bool OnKeyDown([GeneratedEnum] Keycode keyCode, KeyEvent e)
        {
            ...
            switch (keyCode)
            {
                case Keycode.VolumeUp:
                    //fernando 22-10-2022 - traduzir
                    Toast.MakeText(this, "Botão Volume+ foi clicado", ToastLength.Short).Show();
                    e.StartTracking();
                    return true;
